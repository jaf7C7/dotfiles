...
export VISUAL='vi'
export VIMINIT='set compatible tabstop=8 shiftwidth=0 softtabstop=-1 autoindent hidden autoread wildchar=<Tab> history=100 formatprg=fmt\ -p\\\\#\\\ more listchars=tab:»\ ,space:· t_Co=8 background=dark highlight=vr,+ri,=rb,{ri,}rib,k-,<-,x-,Xr'
