...
- [ ] Work through [Eloquent JavaScript](https://eloquentjavascript.net/)
...
- [ ] PROJECT: Make a kanban board web app, with a database and user/admin accounts.
  - [ ] Use Trello for inspiration
  - [ ] Integrate with Google calendar (create event or task)
