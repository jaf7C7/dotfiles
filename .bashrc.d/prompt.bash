# prompt.bash
#
# Functions for setting a helpful shell prompt.
...
#
__prompt_command() {
	# If this command is too slow, uncomment the final part.
	printf '\033]0;%s\007' "${PWD//~/\~}$(__git_ps1)" # & disown $!
}

# Usage: PS1='\w$(__git_ps1) \$ '
#
# A much simplified (and much quicker) version of the prompt
